public abstract class Media : IWatchable
{
    ...
    public static int GetMediaCount() => mediaCount;
    ...
    public int TotalDurationMinutes
    {
        ...
        set
        {
            if (value >= 0) totalDurationMinutes = value;
        }
    }
    ...
    {
        get => currentWatchTimeMinutes;
        set
        {
            if (value >= 0 && value <= TotalDurationMinutes) currentWatchTimeMinutes = value;
        }
    }
    ...
    public void ResetWatchTime() => CurrentWatchTimeMinutes = 0;
