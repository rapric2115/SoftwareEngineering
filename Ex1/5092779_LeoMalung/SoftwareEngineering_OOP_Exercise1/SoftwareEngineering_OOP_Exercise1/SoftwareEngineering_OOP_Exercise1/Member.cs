...
public class Member
{
    ...
    private static int standardMemberLimit = 3;
    private static int premuimMembersLimit = 5;
    ...
    private int GetMaxBorrowLimit()
    {
        ...
        if (MembershipLevel == "Standard")
            return standardMemberLimit;
        else if (MembershipLevel == "Premium")
            return premuimMembersLimit;
        else if (MembershipLevel == "VIP")
            return vipMembersLimit;
        else
