public class Program
{
    public static void Main(string[] args)
    {
        ...
        Member members1 = new Member("John", 21, "Standard Membership");
        Member members2 = new Member("Joy", 20, "Premium Membership");
        Member members3 = new Member("Nick", 21, "VIP Membership");
        ...
        Console.WriteLine($"{members1.Name}, Age: {members1.Age}, " +
            $"Membership Level: {members1.MembershipLevel}, Books Borrowed: {members1.GetBooksBorrowed()}");

        Console.WriteLine($"{members2.Name}, Age: {members2.Age}, " +
            $"Membership Level: {members2.MembershipLevel}, Books Borrowed: {members2.GetBooksBorrowed()}");

        Console.WriteLine($"{members3.Name}, Age: {members3.Age}, " +
            $"Membership Level: {members3.MembershipLevel}, Books Borrowed: {members3.GetBooksBorrowed()}");
