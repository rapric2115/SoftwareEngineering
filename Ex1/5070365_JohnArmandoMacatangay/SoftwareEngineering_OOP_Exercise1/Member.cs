public class Member
{
    ...
    private int GetMaxBorrowLimit()
    {
        ...
        if (MembershipLevel == "Standard Membership")
            return standardMembers;
        else if (MembershipLevel == "Premium Membership")
            return premiumMembers;
        else if (MembershipLevel == "VIP Membership")
            return vipMembers;
        else
    ...
    public void ReturnBook()
    {
        ...
        {
            Console.WriteLine($"{Name} has return all their books.");
        }
